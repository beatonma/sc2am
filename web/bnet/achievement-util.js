 ...
 * but the battle.net API profile response only includes the highest level
 * achieved - all lower levels appear unearned.
 * e.g. If you earn 'WoL: Hard 25', then 'WoL: Hard 5/10/15/20' appear unearned
 *
...
const ACHIEVEMENT_OVERRIDES = [
    ...
    /* FEATS OF STRENGTH */
    /*
     * This could include 1v1 Top [8,25,50,100] [league] achievements
     * but they are not worth any points so we will ignore them for now
     */
];
